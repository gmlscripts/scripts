...
//  @param prec        set to true for precise collision checking, bool
//  @param notme       set to true to ignore the calling instance, bool
//
/// GMLscripts.com/license
function collision_ellipse_list(x1,y1,x2,y2,obj,prec,notme) {
    var dsid,i;
    dsid = ds_list_create();
    with (obj) {
