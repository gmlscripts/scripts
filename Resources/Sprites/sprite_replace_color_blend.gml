...
/// sprite_replace_color_blend(sprite,oldcolor,newcolor,trancolor,htol,stol,vtol,blend)
//
//  Replaces one range of colors of a given sprite with another.
//  A new sprite is created and its resource ID is returned.
...
//      trancolor   transparency color of the new sprite, real
